...
public class Constants {
    ...
    public static final String NEAREST_POINTS ="points/nearest";
    public static final String REGISTER ="register";
    public static final String RECOVER ="recover";
    public static final String HISTORICAL_EVENTS ="historical-events/";
    public static final String ADD_HISTORICAL_EVENT ="testimonials/store";
    public static final String ADD_PRE_PHOTO ="pre-photos/store";
    public static final String ADD_PRE_AUDIO ="pre-audios/store";
    public static final int ENDPOINT_ERROR = 0;
    public static final int ENDPOINT_SUCCESS = 1;
}
